...
class _RegistrationScren extends State<RegistrationScren> {
  ...
  final TextEditingController _revalidatePasController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Inscription',style: TextStyle(color: Colors.white,fontSize: 30
         ),),
      ),
      body: Container(
   ...
   // Cette propriété définit la couleur de la coche
    ...
    SizedBox(height: 20.0),
              ...
              Row(
                ...
                children: [
                  Text('Vous avez deja un compte?',style: TextStyle(color: Colors.white,)),
